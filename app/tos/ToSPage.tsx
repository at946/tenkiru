  ...
  return (
    <div className='container px-5 text-sm'>
      ...
      <ul className='mb-5 list-inside list-decimal'>
        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>規約の適用</li>
          <p>本規約は、ユーザーと本サービスの利用に関わる一切の関係に適用されるものとします。</p>
        </div>

        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>規約の変更</li>
        ...
        <div className='mb-5'>
          ...
          <ul className='ml-4 list-disc'>
            ...
            <li className='mb-1'>
              その他、公序良俗に違反し、または他者の権利を侵害すると運営元が判断した行為。
            </li>
        ...
        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>サービスの一時的な中断</li>
          <p className='mb-2'>
            運営元は、次の各号いずれかの事由に該当する場合、ユーザーに事前に通知することなく、一時的に本サービスの運営を中断することがあります。
          </p>
          <ul className='mb-2 ml-4 list-disc'>
            <li className='mb-1'>本サービスまたは関連設備の保守を定期的または緊急に行うとき。</li>
            <li className='mb-1'>本サービスで利用する通信回線、電力等の提供が中断されたとき。</li>
            <li className='mb-1'>
        ...
        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>免責事項</li>
          <p className='mb-2'>
          ...
          <ul className='ml-4 list-disc'>
            ...
            <ul className='mb-1 ml-4 list-disc'>
              <li className='mb-1'>運営元が提供していないプログラムによって生じる損害。</li>
              <li className='mb-1'>運営元以外の第三者による不正な行為によって生じる損害。</li>
              <li className='mb-1'>
              ...
              <li className='mb-1'>本サービスのバグによって生じる損害。</li>
            </ul>
            <li className='mb-1'>
        ...
        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>本サービスの終了</li>
          <p className='mb-2'>
          ...
          <ul className='ml-4 list-disc'>
            ...
            <li className='mb-1'>
              前項の通知は、本サイト上での掲示やWebサイト上への掲載によるものとします。
            </li>
            <li className='mb-1'>
        ...
        <div>
          <li className='mb-3 text-lg font-semibold'>合意管轄等</li>
          <ul className='ml-4 list-disc'>
            <li className='mb-1'>本規約の解釈にあたっては、日本法を準拠法とします。</li>
            <li>
