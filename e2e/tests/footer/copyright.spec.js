describe('footer/copyright', () => {
  test('トップページで、フッターのコピーライトを選択したとき、開発者のTwitterプロフィールページへ遷移すること', async () => {
    ...
    expect(await page.$eval('[data-testid="copyright"]', el => el.getAttribute('href'))).toBe('https://twitter.com/at_946')
    expect(await page.$eval('[data-testid="copyright"]', el => el.getAttribute('target'))).toBe('_blank')
  })
