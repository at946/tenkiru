...
export const Sequential: Story = {
  ...
  decorators: [
    (story) => {
      return <Provider store={mockStore(closePhaseSequentialMockState)}>{story()}</Provider>;
    },
  ],
};
...
export const TShirtSize: Story = {
  ...
  decorators: [
    (story) => {
      return <Provider store={mockStore(closePhaseTShrirtSizeMockState)}>{story()}</Provider>;
    },
  ],
};
