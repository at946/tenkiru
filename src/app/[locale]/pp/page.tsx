    ...
    <div className='container mx-auto my-10 px-5 text-sm dark:text-white'>
      ...
      <ul className='mb-5 list-inside list-decimal'>
        <div className='mb-5'>
          ...
          <p className='mb-2'>
            {t(
              "The Service uses and collects users' personal information for the following purposes",
            )}
          </p>
        ...
        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>
            {t('Provision of Personal Information to Third Parties')}
          </li>
          <p className='mb-2'>
            {t(
        ...
        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>{t('Management of Personal Information')}</li>
          <p className='mb-2'>
            {t(
        ...
        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>
            {t(
              'Disclosure, Correction, Suspension of Use, Deletion, and Complaints Regarding Personal Information',
            )}
          </li>
          <p>
            {t(
        ...
        <div className='mb-5'>
          <li className='mb-3 text-lg font-semibold'>{t('Privacy')}</li>
          ...
          <div className='mb-4'>
            ...
            <p className='mb-2'>
              ...
              {t.rich(
                'For more information on this policy, please see the Google Analytics Terms of Service and Privacy Policy Privacy and Terms Google',
                {
                  a1: (chunks) => (
                    <LinkInNewTab
                      href={t('URL of Google Analytics Terms of Service')}
                      className='underline'
                    >
                      {chunks}
                    </LinkInNewTab>
            ...
            <p>
              {t(
                'You can prevent Google Analytics from collecting data by disabling cookies in your browser',
              )}
            </p>
          </div>
          ...
          <div>
            ...
            <p className='mb-2'>
              ...
              {t.rich(
                'For more information on this policy, please visit Advertising - Policies and Terms - Google',
                {
                  a: (chunks) => (
                    <LinkInNewTab
                      href={t('URL of Google Advertising Privacy Policy')}
                      className='underline'
                    >
                      {chunks}
                    </LinkInNewTab>
            ...
            <p>
              {t(
                'You can prevent Google AdSense from collecting data by disabling cookies in your browser',
              )}
            </p>
          </div>
        </div>
        ...
        <div>
          <li className='mb-3 text-lg font-semibold'>
            {t(
              'Contact for inquiries and requests for disclosure, etc, concerning personal information',
            )}
          </li>
          <p>
