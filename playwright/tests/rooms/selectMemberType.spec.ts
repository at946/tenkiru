...
test('ルームページで、デフォルトで「Player」が選択されていること', async ({ page, browser }) => {
  await usersJoinRoom(page, urls.room(), browser, 1)
...
test('ルームページで、「Player」選択中かつカード未選択かつカード未オープンの状態で、「Audience」を選択したとき、自分のテーブルカードが消え、手札カードを選べなくなること', async ({ page, browser }) => {
...
test('ルームページで、「Player」選択中かつカード選択済みかつカード未オープンの状態で、「Audience」を選択したとき、自分のテーブルカードが消え、手札カードの選択が解除され、手札カードを選べなくなること', async ({ page, browser }) => {
  const [page2] = await usersJoinRoom(page, urls.room(), browser, 1)
...
test('ルームページで、「Player」選択中かつカード未選択かつカードオープン済みの状態で、「Audience」を選択したとき、自分のテーブルカードが消え、手札カードを選べなくなること', async ({ page, browser }) => {
  const [page2] = await usersJoinRoom(page, urls.room(), browser, 1)
...
test('ルームページで、「Player」選択中かつカード選択済みかつカードオープン済みの状態で、「Audience」を選択したとき、自分のテーブルカードが消え、手札カードの選択が解除され、手札カードを選べなくなること', async ({ page, browser }) => {
  const [page2] = await usersJoinRoom(page, urls.room(), browser, 1)
...
test('ルームページで、「Audience」選択中かつカード未オープンの状態で、「Player」を選択したとき、自分のテーブルカードが現れ、手札カードを選べるようになること', async ({ page, browser }) => {
  const [page2] = await usersJoinRoom(page, urls.room(), browser, 1)
...
test('ルームページで、「Audience」選択中かつカードオープン済みの状態で、「Player」を選択したとき、自分のテーブルカードが現れること', async ({ page, browser }) => {
  const [page2] = await usersJoinRoom(page, urls.room(), browser, 1)
...
test('ルームページで、メンバーが自分ひとりのときに「Audience」を選択しても問題ないこと', async ({ page }) => {
