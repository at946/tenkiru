...
const memberTypeToggle: NextPage<Props> = ({ type, changeMemberType }) => {
  ...
  return (
    <div className="tabs is-toggle is-centered">
      <ul>
        <li className={type === 'player' ? 'is-active' : ''} onClick={() => click('player')} data-testid="memberTypePlayer">
          <a>Player</a>
        </li>
        <li className={type === 'audience' ? 'is-active' : ''} onClick={() => click('audience')} data-testid="memberTypeAudience">
          <a>Audience</a>
        </li>
      </ul>
    </div>    
